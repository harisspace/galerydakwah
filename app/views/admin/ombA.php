...
<div class="modal">
    ...
    <form action="<?= BASEURL; ?>/omb/tambah" method="POST">
...
<div class="track">
    ...
    <?php foreach ($data['videos'] as $video) : ?>
        ...
        <a href="<?= BASEURL; ?>/omb/video/<?= $video['id'] ?>" class="track-video is-black"><?= $video["judul"] ?>

            <a href="<?= BASEURL; ?>/omb/hapus/<?= $video['id'] ?>" class="is-black link" onclick="return confirm('apakah anda yakin??')">hapus</a> |

            <a href="<?= BASEURL; ?>/omb/ubah/<?= $video['id'] ?>" class="is-black link">ubah</a>
