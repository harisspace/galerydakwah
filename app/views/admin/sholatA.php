...
<div class="modal">
    ...
    <form action="<?= BASEURL; ?>/sholat/tambah" method="POST">
...
<div class="track">
    ...
    <?php foreach ($data['videos'] as $video) : ?>
        ...
        <a href="<?= BASEURL; ?>/sholat/video/<?= $video['id'] ?>" class="track-video is-black"><?= $video["judul"] ?>
            ...
            <a href="<?= BASEURL; ?>/sholat/hapus/<?= $video['id'] ?>" class="is-black link" onclick="return confirm('apakah anda yakin??')">hapus</a> |

            <a href="<?= BASEURL; ?>/sholat/ubah/<?= $video['id'] ?>" class="is-black link">ubah</a>
